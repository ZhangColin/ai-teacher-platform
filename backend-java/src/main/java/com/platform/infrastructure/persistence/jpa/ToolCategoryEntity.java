 ...
 * 工具分类JPA实体
 *
 * 对应Python: backend/src/db_models.py中的ToolCategoryModel
 * 对应数据库表: tool_categories
 *
 * @author AI Teacher Platform
 */
@Entity
@Table(name = "tool_categories", indexes = {
...
public class ToolCategoryEntity {
    ...
    private List<CommonToolEntity> tools = new ArrayList<>();
