...
**作为** AI初学者  
**我想要** 通过简单对话生成专业的提示词  
**以便** 提高我使用AI的效果，无需学习复杂的提示词工程

**作为** 内容创作者  
**我想要** 快速生成适合我场景的提示词  
**以便** 让AI更准确地理解我的需求并产出高质量内容

**作为** 产品经理  
**我想要** 生成结构化的提示词  
**以便** 让AI帮我完成各种专业任务（文案、分析、规划等）
...
**维护人**: PM Team  
**更新说明**: 
- v1.1 - 更新第4节，集成实际的系统提示词（六步引导法）
- v1.2 - 简化第3节布局设计，移除具体样式，专注于功能结构
- v2.0 - 删除所有技术实现细节，还原为纯粹的功能需求文档
