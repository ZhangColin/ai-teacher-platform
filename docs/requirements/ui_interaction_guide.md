...
|------|------|------|
| `/` | 首页 | 功能入口 |
| `/ai/wizard` | AI提示词向导 | MVP核心功能 |
| `/ai/chat` | 智能对话 | 暂未实现，显示开发中 |
| `/ai/image` | AI绘图 | 暂未实现，显示开发中 |
| `/ai/code` | AI编程 | 暂未实现，显示开发中 |
| `/showcase` | 成果展示首页 | 重定向到 `/showcase/code` |
| `/showcase/code` | AI编程作品 | 成果展示 |
| `/showcase/image` | AI图片作品 | 成果展示 |
| `/showcase/teaching` | 教学案例 | 成果展示 |
| `/tools` | 工具列表 | 工具入口 |
| `/tools/:toolId` | 工具详情 | 具体工具页面 |
